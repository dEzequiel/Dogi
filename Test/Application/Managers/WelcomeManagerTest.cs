...
namespace Test.Application.Managers
{
    public class WelcomeManagerTest
    {
        ...
        [AutoMoqData]
        internal async Task
            ShouldRegisterInformationAboutReceptionDocumentAndIndividualProceedingIfAnimalHasNoChipAsync(
        ...
        [AutoMoqData]
        internal async Task
            ShouldRegisterInformationAboutReceptionDocumentIndividualProceedingAndAnimalChipIfAnimalHasChipAndOwnerIsResponsibleAsync(
                [Frozen] Mock<IMediator> mediatorMock,
                ApiResponse<ReceptionDocument> receptionDocumentApiResponse,
                ApiResponse<IndividualProceeding> individualProceedingApiResponse,
                ApiResponse<Cage> cageApiResponse,
